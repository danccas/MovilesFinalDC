class HeroDC {
  ...
  HeroDC.fromJson(Map<String, dynamic> json) {
...
class Powerstats {
  ...
  Powerstats.fromJson(Map<String, dynamic> json) {
    intelligence = 20;//json['intelligence'];
    strength = 20;//json['strength'];
    speed = 20;//json['speed'];
    durability = 20;//json['durability'];
    power = 20;//json['power'];
    combat = 20;//json['combat'];
  }
...
class Images {
  ...
  Images({this.url, this.xs, this.sm, this.md, this.lg});
